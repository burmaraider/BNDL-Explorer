...
namespace BNDL_Explorer.Viewer
{
    ...
    public class Texture
    {
        ...
        public static Texture LoadFromFileDDS(string path)
        {
            MemoryStream imageStream = new MemoryStream(File.ReadAllBytes(path));
            Bitmap texture;
            ...
            try
            {
                ...
                {
                    System.Drawing.Imaging.PixelFormat format = (image.Format == Pfim.ImageFormat.Rgba32) ? System.Drawing.Imaging.PixelFormat.Format32bppArgb : System.Drawing.Imaging.PixelFormat.Format24bppRgb;
                    ...
                    try
                    {
                        ...
                        texture = new Bitmap(image.Width, image.Height, image.Stride, format, data);
                        ...
                        // Generate handle
                        int handleTex = GL.GenTexture();

                        // Bind the handle
                        GL.ActiveTexture(TextureUnit.Texture0);
                        GL.BindTexture(TextureTarget.Texture2D, handleTex);
